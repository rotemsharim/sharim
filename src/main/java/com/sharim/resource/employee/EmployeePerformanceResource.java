...
import com.sharim.dto.EmployeePerformanceUpdateDto;
...
import com.sharim.services.EmployeePerformanceConfirmationService;
import com.sharim.services.PerformanceService;
import com.sharim.converters.EmployeePerformanceToEmployeePerformanceDtoConverter;
...
public class EmployeePerformanceResource {
    ...
    public ResponseEntity<?> updateEmployeePerformanceDetails(@PathVariable("id") String id,
        ...
        if (employeePerformanceUpdate.getConfirm() != null) {
            ...
            logger.info("updated confirmation for performance with id {} for emp {}", perId, id);
        }
